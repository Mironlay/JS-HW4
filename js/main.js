...
const userName = "bejba";
const lastName= "aeaea";
if (userName.includes(""), lastName.includes("")) {
...
const text = "JavaScript is the best language!";
...
const user = "Miro"
const mail = "abracadabra@gmail.com"
const password = "123456"
if (user.length >= 3 && mail.includes("@", ".") && password.length >= 6) {
